...
const UpdateProfile = () => {
  ...
  return (
    <div>
      <div className="w-full md:w-4/12 border-2 rounded-md p-5 flex flex-col items-center mx-auto mt-20 md:mt-0">
        <img
        ...
        <form action="" onSubmit={handleUpdateProfile} className="my-4 w-full">
          ...
          <div className="flex gap-2">
            <div className="w-[30%] md:w-[20%] text-white">
              <select
          ...
          <div className="flex gap-2">
            ...
            <input
              ...
              id=""
              className="input input-bordered w-full text-white"
              defaultValue={currentUser?.wapp}
            />
          </div>

          <input
            className="btn btn-warning w-full my-4 text-xl"
            type="submit"
