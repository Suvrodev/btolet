...
const BuyFilter = () => {
    ...
    const {baseUrl,lattitude,longitude,doubleLocation,selectedFacilities,selectedAmenities}=useContext(AuthContext)
    ...
    },[doubleLocation,minPrice,maxPrice,selectedCategoriesBuySort,selectedBedrooms,selectedBathrooms,selectedAmenities])
