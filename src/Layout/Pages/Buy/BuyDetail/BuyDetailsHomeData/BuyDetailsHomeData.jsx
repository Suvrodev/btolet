  ...
  return (
    <div className="flex flex-col justify-center items-center gap-2 ">
      ...
      <div className="w-[60px] h-[60px] bg-[#edf0ef] rounded-full flex items-center justify-center p-3">
        <img className="w-[30px]" src={iconName} alt="" />
      </div>

      <div className="flex flex-col items-center justify-start w-[100px] h-[40px]  ">
        <p className="text-[18px] ">{itemName}</p>
        <p className=" text-lg text-center">{itemNumber}</p>
      </div>
    </div>
  );
};
